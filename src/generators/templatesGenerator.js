...
var fileNames = {
  ...
  popularFile: 'popular/index.html',
...
var allData = [
  ...
  },
  {
    templateData: {
      ...
      description:
        '{{ name.spacedValue }} for GNU Emacs.' +
  ...
  },
  {
    templateData: {
      ...
      description:
        'Page {{ pageNumber }} of {{ allPagesNumber }} Themes.' +
        ' | Emacs Themes',
      relativePath: '../',
    },
  ...
  },
  {
    templateData: {
      ...
      description: 'Themes search' + ' | Emacs Themes',
      relativePath: '../',
    },
  ...
  },
  {
    templateData: {
      name: 'tag-index',
      title:
        'Tag "{{ tag.spacedValue }}" - Page {{ currentPage }} ' +
        ' | Emacs Themes',
      description:
        'Page {{ currentPage }} for the tag {{ tag.spacedValue }}.' +
        ' | Emacs Themes',
      relativePath: '../../',
    },
  ...
  },
  {
    templateData: {
      name: 'popular',
      title: 'Popular Emacs Themes Charts',
      description: 'Most popular Emacs Themes',
      relativePath: '../',
    },
    schema: ['header', 'popular', 'footer'],
  },
  {
    templateData: {
      name: 'about',
      ...
      description:
        'About Emacs Themes site. How to contribute and what it' + 'contains',
      relativePath: '../',
    },
...
function generateAllTemplates(allPartialTexts) {
  ...
  allData.forEach(function(data) {
    ...
    res[data.templateData.name] = replaceInTemplate(
      basicTemplate,
      data.templateData,
    );
  });
