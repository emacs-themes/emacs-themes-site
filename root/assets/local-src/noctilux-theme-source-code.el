; when in GUI mode, forces Noctilux to use the 256
...
<pre class="lang:lisp decode:true" title="Noctilux">;;; noctilux-theme.el --- Dark theme inspired by LightTable
...
;;; noctilux-theme.el ends here</pre>
&nbsp;