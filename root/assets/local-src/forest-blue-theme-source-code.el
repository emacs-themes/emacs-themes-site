...
;;; Code:
 ...
 (deftheme forest-blue)
 (let ((class '((class color) (min-colors 89)))
    ; ;;(defun on-after-init ()
    ; (unless (display-graphic-p (selected-frame))
    ;   (bg1 "unspecified-bg" (selected-frame)))

       (fg1 "#e8dfd7")
       (fg2 "#d3cbc4")
       (fg3 "#bfb8b1")
       (fg4 "#aba49f")
       (bg1 (if (display-graphic-p (selected-frame)) "#203439" "unspecified-bg"))
       (bg2 "#304247")
       (bg3 "#405155")
       (bg4 "#506064")
       (key2 "#3b73b2")
   ...
   `(region ((,class (:background ,bg2 :foreground ,fg1))))
   ...
   `(powerline-active1 ((,class (:background ,bg1 :foreground ,fg1))))
   ...
   `(helm-selection-line ((,class (:background ,func))))
