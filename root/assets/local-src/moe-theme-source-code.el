...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-structure ((,class (:foreground ,black-4 :background ,blue-1 :bold t))))
   ...
   `(org-agenda-date ((,class (:foreground ,blue-0 :background ,black-5 :underline nil))))
   `(org-agenda-date-weekend ((,class (:foreground ,blue-3 :underline nil :bold nil))))
   `(org-agenda-date-today ((,class (:foreground ,blue-0 :slant italic :weight bold))))
   ...
   `(magit-item-highlight ((,class (:background ,black-3 :foreground ,white-0))))
   ...
   `(magit-log-head-label-patches ((,class (:foreground ,black-5 :background ,orange-2 :bold t :underline t))))
   `(magit-log-head-label-remote ((,class (:foreground ,blue-3 :background ,blue-1 :bold t :underline t))))
   ...
   `(magit-log-reflog-label-reset ((,class (:foreground ,black-3 :background ,red-0))))
...
<pre class="lang:lisp decode:true" title="Moe Light">;;; moe-light-theme.el --- An eye-candy theme for Emacser
...
;;; moe-light-theme.el ends here</pre>
&nbsp;