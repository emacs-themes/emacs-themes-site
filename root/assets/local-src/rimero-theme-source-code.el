...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(jde-java-font-lock-constant-face ((t (:foreground ,fg2))))
   `(jde-java-font-lock-modifier-face ((t (:foreground ,key3))))
   `(jdee-font-lock-constructor-face ((t (:foreground ,func :weight bold))))
   ...
   `(markdown-blockquote-face ((t :foreground ,comment)))
   `(markdown-header-delimiter-face ((,class (:inherit markdown-header-face))))
   `(markdown-header-face ((t (:foreground ,var :weight bold))))))
